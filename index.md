...
venue: "Australian Carpentries Consortium"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
...
humandate: "March 5-8, 2024"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "9:00am to 1:00pm AWST each day"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
...
instructor: ["Ann Backhaus","Sara King","Mark Crowe"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
